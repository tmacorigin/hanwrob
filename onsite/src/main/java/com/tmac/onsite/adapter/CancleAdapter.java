 ...
 * @author tmac
 */
public class CancleAdapter extends CommonAdapter<NoBeginBean> {

	public CancleAdapter(Context context, List<NoBeginBean> list) {
		super(context, list);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = inflater.inflate(R.layout.cancle_list_item, parent, false);
