 ...
 * @author tmac
 */
public class FinishedAdapter extends CommonAdapter<NoBeginBean> {

	public FinishedAdapter(Context context, List<NoBeginBean> list) {
		super(context, list);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = inflater.inflate(R.layout.finished_list_item, parent, false);
