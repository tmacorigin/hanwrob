...
import com.tmac.onsite.adapter.FinishedAdapter;
...
public class FinishedFragment extends Fragment {
	...
	private static final String TAG = "LC-FinishedFragment";
...
//				if(taskBean.getTaskState().equals("2")){
...
//		}
	...
	private void initViews(View view) {
		// TODO Auto-generated method stub
		ptrl = (PullToRefreshLayout) view.findViewById(R.id.finished_pull_layout);
		plv = (PullableListView) view.findViewById(R.id.finished_pull_listview);
		adapter = new FinishedAdapter(getActivity(), allList);
	}
	...
	private void initEvents() {
		...
		plv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				startActivity(new Intent(getActivity(), DetailFinishActivity.class));
				...
				if(clickBean.getReadState().equals("0")){
					...
					for (int index = 0;index < getDataList.size(); index ++){
						TaskBean taskBean = (TaskBean) getDataList.get(index);
						if(taskBean.getTaskState().equals("2") && taskBean.getTaskId().equals(clickBean.getTaskId())){
	...
	public void onEvent(Object event) {
		Log.d("FinishedFragment", "onEvent");
