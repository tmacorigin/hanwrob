...
import com.tmac.onsite.activity.DetailCancleActivity;
import com.tmac.onsite.activity.DetailCannotFinishActivity;
import com.tmac.onsite.adapter.CancleAdapter;
...
public class CancleFragment extends Fragment {
	...
	private static final String TAG = "LC-CancleFragment";
	...
	public static boolean isCancleSend = false;
...
//		}
	...
	private void initViews(View view) {
		// TODO Auto-generated method stub
		ptrl = (PullToRefreshLayout) view.findViewById(R.id.cancle_pull_layout);
		plv = (PullableListView) view.findViewById(R.id.cancle_pull_listview);
		adapter = new CancleAdapter(getActivity(), allList);
	}
	...
	private void initEvents() {
		...
		plv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				startActivity(new Intent(getActivity(), DetailCancleActivity.class));
				...
				if(clickBean.getReadState().equals("0")){
					...
					for (int index = 0;index < getDataList.size(); index ++){
						TaskBean taskBean = (TaskBean) getDataList.get(index);
						if(taskBean.getTaskState().equals("4") && taskBean.getTaskId().equals(clickBean.getTaskId())){
