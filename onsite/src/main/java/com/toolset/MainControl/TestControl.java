...
public class TestControl {
    ...
    public static void saveDataToDB(Context mContext){
        ...
        TaskBean taskBean1 = new TaskBean("h001","0","上海","2016-11-26","0","1","2016-10-19");
        ...
        TaskBean taskBean3 = new TaskBean("h003","2","广州","2016-11-25","0","1","2016-10-19");
        taskBeanArrayList.add(taskBean3);
        TaskBean taskBean4 = new TaskBean("h004","3","深圳","2016-10-24","0","0","2016-10-19");
        taskBeanArrayList.add(taskBean4);
        TaskBean taskBean5 = new TaskBean("h005","4","浙江","2016-10-23","0","1","2016-10-19");
        taskBeanArrayList.add(taskBean5);
        TaskBean taskBean6 = new TaskBean("h006","0","江苏","2016-10-22","0","1","2016-10-19");
        ...
        TaskBean taskBean8 = new TaskBean("h008","2","安徽","2016-10-20","0","1","2016-10-19");
        taskBeanArrayList.add(taskBean8);

        TaskBean taskBean9 = new TaskBean("h009","3","合肥","2016-10-19","0","0","2016-10-19");
        taskBeanArrayList.add(taskBean9);
        TaskBean taskBean10 = new TaskBean("h010","4","湖南","2016-10-18","0","0","2016-10-19");
        taskBeanArrayList.add(taskBean10);
        TaskBean taskBean11 = new TaskBean("h011","0","湖北","2016-10-17","0","1","2016-10-19");
        ...
        TaskBean taskBean13 = new TaskBean("h013","2","武汉","2016-10-15","0","1","2016-10-19");
        taskBeanArrayList.add(taskBean13);
        TaskBean taskBean14 = new TaskBean("h014","3","广东","2016-10-14","0","0","2016-10-19");
        ...
        TaskBean taskBean16 = new TaskBean("h016","0","苏州","2016-10-12","0","0","2016-10-19");
